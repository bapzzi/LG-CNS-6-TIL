...
| 시간 | 내용 |
|---|---|
| 09:10~10:20 | 서블릿·JPA Entity 개념, DML, DTO에 setter를 두지 않는 이유 |
| 09:40~11:10 | 입력(insert) 완성, 삭제(delete), 수정(update) |
| 13:00~13:45 | 입출력 통로의 종류, 예외 처리와 닫기 |
| 14:00~14:45 | 파일 읽기·쓰기, 객체 직렬화 |
| 15:15~ | 게시판에 저장·로딩 붙이기, 응답을 한 봉투로 감싸기 |
